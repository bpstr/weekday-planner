...
export const seoConfig = {
	baseURL: "https://bpstr.github.io/weekday-planner", // Change this to your production URL.
	description:
...
export const manifest: Partial<ManifestOptions> = {
	...
	icons: [
		{
			src: seoConfig.baseURL + "/favicons/favicon-192x192.png",
			sizes: "192x192",
			type: "image/png"
		},
		{
			src: seoConfig.baseURL + "/favicons/favicon-512x512.png",
			sizes: "512x512",
			type: "image/png"
		},
		{
